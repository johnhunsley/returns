...
public class ReturnsRepositoryIntegrationTest {
    ...
    @Test
    public void testPageReturnsByName() {
    ...
    public void testGetCatchCountForFisheryAndDateRange() {
        Integer count = returnsRepository.getCatchCountForFisheryAndDateRange(DateTime.now().minusDays(25).toDate(), DateTime.now().toDate(), "Wroxeter");
        System.out.println(count);
    }

    @Test
    public void testFindReturnsByFisheryAndDateRange() {
